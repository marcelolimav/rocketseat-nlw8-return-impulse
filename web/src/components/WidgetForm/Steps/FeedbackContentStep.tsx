  ...
  return (
    <>
      <header>
        <button
          type="button"
          className="to-5 left-5 absolute text-zinc-400 hover:text-zinc-100"
        ...
        <footer className="flex gap-2 mt-2">
          ...
          <button
            ...
            items-center text-sm hover:bg-brand-300 focus:outline-none focus:ring-2 focus:ring-offset-2  
             focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors disabled:opacity-50 disabled:hover:bg-brand-300"
          >
